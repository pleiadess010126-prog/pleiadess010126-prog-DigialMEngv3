                ...
                <div className="bg-white rounded-3xl border border-slate-200 overflow-hidden shadow-xl">
                    <div className="overflow-x-auto">
                        <table className="w-full">
                            ...
                            <tbody>
                                {[
                                    { feature: 'AI Content Generation', values: ['10/mo', '100/mo', '500/mo', 'Unlimited'] },
                                    { feature: 'Publishing Platforms', values: ['1', '3', '5 + TikTok', 'All'] },
                                    ...
                                    { feature: 'Multi-language Support', values: ['—', '5 languages', '20+ languages', 'All'] },
                                    { feature: 'WordPress Publishing', values: [true, true, true, true] },
                                    { feature: 'YouTube Shorts', values: [false, true, true, true] },
                                    { feature: 'Instagram Reels', values: [false, true, true, true] },
                                    { feature: 'TikTok', values: [false, false, true, true] },
                                    { feature: 'Analytics Dashboard', values: ['Basic', 'Standard', 'Advanced', 'Enterprise'] },
